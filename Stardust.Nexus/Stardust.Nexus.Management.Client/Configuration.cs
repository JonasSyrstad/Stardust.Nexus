...
namespace Stardust.Interstellar.Config
{
    public static class Configuration
    {
        public static void SetCacheHandler(IConfigReaderCache cacheHandler)
        {
            ...
            cacheHandler?.SetReaderProxy(ProxyFactory.CreateInstance<IConfiguration>(ConfigUrl));
            cache = cacheHandler;
        }
        public static void SetApiToken(IConfiguration reader, string token, string tokenKey)
        {
        ...
        public static ConfigurationSet GetConfiguration(string setName, string environmentName)
        {
            ...
            configData = ProxyFactory.CreateInstance<IConfiguration>(ConfigUrl).GetConfiguration(setName, environmentName);
